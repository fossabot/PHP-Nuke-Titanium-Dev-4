...
echo '<table class="outer_table_opacity" border="0" width="240px" align=center cellpadding="0" cellspacing="0">';
echo '<tr>';
...
echo '<td id="sidebg" class="sideblock_flames" height"0" valign="top" >';
